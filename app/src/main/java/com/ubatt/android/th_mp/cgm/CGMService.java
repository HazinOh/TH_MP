...
public class CGMService extends BleProfileService implements CGMManagerCallbacks {
    ...
    public static final String BROADCAST_NEW_CGMS_VALUE = "com.ubatt.android.th_mp.cgms.BROADCAST_NEW_CGMS_VALUE";
    public static final String BROADCAST_DATA_SET_CLEAR = "com.ubatt.android.th_mp.cgms.BROADCAST_DATA_SET_CLEAR";
    public static final String OPERATION_STARTED = "com.ubatt.android.th_mp.cgms.OPERATION_STARTED";
    public static final String OPERATION_COMPLETED = "com.ubatt.android.th_mp.cgms.OPERATION_COMPLETED";
    public static final String OPERATION_SUPPORTED = "com.ubatt.android.th_mp.cgms.OPERATION_SUPPORTED";
    public static final String OPERATION_NOT_SUPPORTED = "com.ubatt.android.th_mp.cgms.OPERATION_NOT_SUPPORTED";
    public static final String OPERATION_FAILED = "com.ubatt.android.th_mp.cgms.OPERATION_FAILED";
    public static final String OPERATION_ABORTED = "com.ubatt.android.th_mp.cgms.OPERATION_ABORTED";
    public static final String EXTRA_CGMS_RECORD = "com.ubatt.android.th_mp.cgms.EXTRA_CGMS_RECORD";
    public static final String EXTRA_DATA = "com.ubatt.android.th_mp.cgms.EXTRA_DATA";
